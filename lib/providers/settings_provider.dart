...
class SettingsProvider with ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'Bahasa Indonesia': {
      ...
      'analisis_bulanan_deskripsi': 'Hebat! Pengeluaran Anda di bulan ini turun 15% dibanding rata-rata bulan lalu. Sisa saldo {balance} ideal dialokasikan langsung ke Catatanku.',
      ...
      'hak_cipta': 'Hak Cipta © 2026 Catatanku.\nSemua Hak Dilindungi.',
    ...
    'English': {
      ...
      'analisis_bulanan_deskripsi': 'Great! Your spending this month is 15% lower than last month. The remaining balance of {balance} is ideally allocated directly to Catatanku.',
      ...
      'hak_cipta': 'Copyright © 2026 Catatanku.\nAll Rights Reserved.',
    ...
    '日本語': {
      ...
      'analisis_bulanan_deskripsi': '素晴らしい！今月の支出は先月平均より15％少なく、残高 {balance} は Catatanku に直接配分するのに理想的です。',
    ...
    'العربية': {
      ...
      'analisis_bulanan_deskripsi': 'رائع! إنفاقك هذا الشهر أقل بنسبة 15٪ من الشهر الماضي. الرصيد المتبقي {balance} من المثالي تخصيصه مباشرة إلى Catatanku.',
      ...
      'hak_cipta': 'حقوق النشر © 2026 Catatanku.\nجميع الحقوق محفوظة.',
